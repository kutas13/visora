...
set SHORTCUT=%STARTUP%\VisoraWhatsApp.lnk

echo.
echo ===================================================
echo   Visora - WhatsApp Servisi Kurulumu
echo ===================================================
echo.
echo Kisayol olusturuluyor...

powershell -Command "$ws = New-Object -ComObject WScript.Shell; $sc = $ws.CreateShortcut('%SHORTCUT%'); $sc.TargetPath = '%TARGET%'; $sc.WorkingDirectory = '%~dp0'; $sc.WindowStyle = 7; $sc.Description = 'Visora WhatsApp Servisi'; $sc.Save()"
