    ...
    <div className="space-y-5">
      ...
      {groups.length === 0 ? (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-10 text-center">
          ...
          <p className="text-slate-500 text-sm mb-4">Henüz grup yok</p>
      ...
      <Modal isOpen={showCreateModal} onClose={() => setShowCreateModal(false)} title="Yeni Grup" size="sm">
        <form onSubmit={handleCreateGroup} className="space-y-4">
          ...
          <div>
            ...
            <textarea placeholder="Açıklama..." value={grupNot} onChange={(e) => setGrupNot(e.target.value)} rows={2} className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all" />
          </div>
