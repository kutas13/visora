    ...
    <div className="space-y-6">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight mt-0.5">Cari Hesabım</h1>
          <p className="text-slate-500 text-sm mt-1">Carili dosyalarınızın borç ve tahsilat özeti</p>
        </div>
      </div>
