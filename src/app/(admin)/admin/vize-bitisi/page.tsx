    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
        <div className="flex items-start gap-4">
          <span className="w-1.5 h-14 rounded-full bg-gradient-to-b from-rose-500 via-pink-500 to-fuchsia-500" />
          <div>
            <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-rose-600">Operasyon</p>
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight mt-0.5">Vize Bitişi Takibi</h1>
            <p className="text-slate-500 text-sm mt-1 max-w-xl">
              Tüm personelin onaylı vizelerinin bitiş tarihleri ve süresi yaklaşan dosyalar.
            </p>
          </div>
        </div>
        <div className="min-w-[180px]">
          <Select options={staffOptions} value={filterStaff} onChange={(e) => setFilterStaff(e.target.value)} />
        </div>
      </div>
