...
const USER_AVATARS: Record<string, string> = {
  YUSUF: "/yusuf-avatar.png", DAVUT: "/davut-avatar.png", SIRRI: "/sirri-avatar.png", ERCAN: "/ercan-avatar.jpg", BAHAR: "/bahar-avatar.jpg",
};
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-navy-900">Gruplar</h1>
          <p className="text-navy-500 text-sm">{groups.length} grup</p>
        </div>
      ...
      {groups.length === 0 ? (
        <div className="bg-white rounded-xl border border-navy-200 p-10 text-center">
          ...
          <p className="text-navy-500 text-sm mb-4">Henüz grup oluşturulmamış</p>
                    ...
                    <div key={file.id} className="flex items-center gap-3 p-3 bg-navy-50 rounded-lg">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          ...
                          <span className="text-[11px] text-navy-500">{file.profiles?.name}</span>
                        </div>
                      </div>
