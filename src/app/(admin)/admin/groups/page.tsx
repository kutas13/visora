      ...
      <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight mt-0.5">Gruplar</h1>
            <p className="text-slate-500 text-sm mt-1">Aile / topluluk grupları, toplu dosya takibi · <span className="font-bold text-teal-600">{groups.length}</span> grup</p>
          </div>
        </div>
        <button
                  ...
                  return (
                    <div key={file.id} className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                      ...
                      <div className="flex gap-1">
                        <button onClick={() => router.push(`/admin/files/${file.id}/edit`)} className="p-1.5 text-slate-400 hover:text-primary-600 hover:bg-primary-50 rounded transition-colors">
