...
const MONTHLY_REPORT_ALLOWED = ["DAVUT", "YUSUF", "BAHAR", "ERCAN"];
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        restrictTo: MONTHLY_REPORT_ALLOWED,
    ...
    <aside className="h-full w-[260px] bg-[#0b1120] flex flex-col border-r border-white/[0.06]">
      ...
      <div className="flex items-center gap-3 px-4 py-4 flex-shrink-0">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[10px] text-blue-400 font-medium">Personel Paneli</p>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-2.5 py-2 sidebar-scroll">
        {isZafer ? (
          <div>
            <p className="px-2.5 mb-1 text-[9px] font-bold uppercase tracking-[0.15em] text-slate-600">Menü</p>
            {zaferItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-2.5 px-2.5 py-[7px] rounded-md mb-[1px] transition-all duration-100 group text-[13px] ${
                    isActive
                      ? "bg-blue-500/90 text-white font-medium shadow-sm shadow-blue-500/20"
